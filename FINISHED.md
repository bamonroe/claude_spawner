# Finished features (archive)

Fully-completed, code-verified work moved out of `TODO.md` so that file stays a
lean list of *open* work. Nothing here is actionable — it is the historical record.
The move-out rule and the doc map live in `CLAUDE.md`; open/active work lives in `TODO.md`.
...
## Completed work log (swept from the Active section)
